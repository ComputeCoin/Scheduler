...
\begin{document}
	...
	\section{Training}
		...
		\begin{enumerate}
			...
			The flow rate is the number of jobs that the system can process within a given time interval. This is dependent on the interdeparture times, the maximum total time and the sum of all total times a job is in the system. A minmization in expected interdeparture times will lead to more jobs being completed in a given time interval, meaning a higher flow rate.
